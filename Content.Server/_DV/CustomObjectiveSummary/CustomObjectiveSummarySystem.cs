...
using Content.Shared.Objectives.Systems; // Aurora's Song
...
public sealed partial class CustomObjectiveSummarySystem : EntitySystem
{
    ...
    [Dependency] private TargetSystem _target = default!; // Aurora's Song
    ...
    {
        var allMinds = _target.GetAliveHumans(); // Aurora's Song - _mind>_target
