...
public sealed partial class AntagSelectionSystem
{
        ...
        bool checkPref = true)
    {
        ...
        // Frontier: ignore non-whitelisted/blacklisted entities // Aurora's Song - convert to use AttachedEntity
        if (player.AttachedEntity != null
            && (_whitelist.IsWhitelistFail(def.Whitelist, player.AttachedEntity.Value)
                || _whitelist.IsWhitelistPass(def.Blacklist, player.AttachedEntity.Value)))
            return false;
        // End Frontier
